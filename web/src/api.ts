...
export interface TargetSnapshot { averageLatencyMs: number | null; failureCount: number; id: string; lastProbe: ProbeResult | null; sli: number | null; state: TargetState; successCount: number; url: string; }
